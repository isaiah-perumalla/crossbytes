...
use std::path::Path;
use std::ptr::NonNull;
use std::sync::atomic::{AtomicBool, AtomicI16, AtomicI32, AtomicI64, AtomicI8, AtomicU16, AtomicU32, AtomicU64, AtomicU8};
use memmap::MmapMut;
...
mod tests {
    ...
    use crate::bytes::{AtomicBuffer, AtomicRefCell, Bytes};
